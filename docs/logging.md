...
```
drot 0.11.1 started — mode=direct, workers=4, extension=dhara_storage
```
...
```
INFO  drot 0.11.1 started — mode=interactive, workers=4, extension=dhara_storage
...
```
INFO  drot 0.11.1 started — mode=direct, workers=4, extension=dhara_storage
