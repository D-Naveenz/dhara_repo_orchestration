//! Visual Studio / MSVC Developer Shell helpers (Windows).
...
/// Commands that do not require MSVC tooling; skip eager DevShell re-exec.
...
/// Re-executes the current binary under Enter-VsDevShell when not already in a VS dev env.
///
