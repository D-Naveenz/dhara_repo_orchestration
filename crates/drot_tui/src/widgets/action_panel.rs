...
use drot_cli::interactive::AppState;
...
fn status_tone(state: &AppState) -> ValidationTone {
    match state.status_tone {
        drot_cli::StatusTone::Ready => ValidationTone::Muted,
        drot_cli::StatusTone::Running => ValidationTone::Muted,
        drot_cli::StatusTone::Success => ValidationTone::Success,
        drot_cli::StatusTone::Failed => ValidationTone::Error,
        drot_cli::StatusTone::Warning => ValidationTone::Muted,
    }
}
