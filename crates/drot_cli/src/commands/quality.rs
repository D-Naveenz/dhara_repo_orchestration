...
pub(crate) fn quality_fmt_command(context: &ToolContext, args: &[String]) -> Result<CommandResult> {
    ...
    drot_ops::quality::run_fmt(&context.repo_root, args.check)?;
...
pub(crate) fn quality_clippy_command(
    ...
    drot_ops::quality::run_clippy(&context.repo_root)?;
...
pub(crate) fn quality_doc_command(context: &ToolContext, args: &[String]) -> Result<CommandResult> {
    ...
    drot_ops::quality::run_doc(&context.repo_root)?;
...
pub(crate) fn quality_test_rust_command(
    ...
    drot_ops::quality::run_test_rust(&context.repo_root)?;
...
pub(crate) fn quality_test_dotnet_command(
    ...
    drot_ops::quality::ensure_dotnet_available()?;
    drot_ops::quality::run_test_dotnet(&context.repo_root, &config)?;
